...
//	}
	...
	public int hashCode() {
		...
		return address.hashCode() + proximityUuid.hashCode();
	}
	/**
	...
	public boolean equals(Object that) {
		...
		//return (thatIBeacon.getMajor() == this.getMajor() && thatIBeacon.getMinor() == this.getMinor() && ((thatIBeacon.getProximityUuid() == null &&  this.getProximityUuid() == null)||thatIBeacon.getProximityUuid().equals(this.getProximityUuid()) )&& thatIBeacon.getAddress().equals(this.getAddress()));
		return thatIBeacon.getAddress().equals(this.getAddress());
	}
	/**
	 ...
	 */
	public static IBeacon fromScanData(byte[] scanData, int rssi, String address) {
...
//	huge log		Log.d(TAG, "This is not an iBeacon advertisment.  The bytes I see are: "+bytesToHex(scanData));
			return null;
		}
		...
		if(! address.startsWith("19:18")) //liy
			return null;
		iBeacon.address = address;
		return iBeacon;
	}
	...
	protected IBeacon(IBeacon otherIBeacon) {
		...
		this.address = otherIBeacon.address;
	}
